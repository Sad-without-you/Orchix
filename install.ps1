...
Write-BoxLine "" "Green"
Write-BoxLine "   Web UI:  http://localhost:5000" "Green"
Write-BoxLine "   CLI:     orchix.ps1" "Green"
Write-BoxLine "" "Green"
Write-BoxLine "   orchix.ps1 service stop    # Stop Web UI" "Green"
Write-BoxLine "   orchix.ps1 service status  # Check status" "Green"
Write-BoxLine "" "Green"
