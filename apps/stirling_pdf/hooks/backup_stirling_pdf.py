...
def backup_stirling_pdf(container_name: str) -> bool:
    '''Backup Stirling PDF logs and configuration'''
    from cli.backup_menu import BACKUP_DIR
    from utils.system import is_windows
    
    show_info("Using volume backup for Stirling PDF...")
...
def _create_metadata(container_name, backup_file):
    ...
    create_metadata(container_name, backup_file, 'stirling_pdf')
