...
class StirlingPdfUpdater(BaseUpdater):
    '''Updater for Stirling PDF'''
    
    def get_available_actions(self):
        '''Stirling PDF supports version updates'''
        return ['version_update']
    
    def version_update(self):
        '''Update Stirling PDF to latest version'''
        try:
            ...
            result = run_docker_with_progress(
                ...
                "Pulling stirlingtools/stirling-pdf:latest",
                encoding='utf-8',
                errors='ignore'
            )
            ...
            if compose_file:
                ...
                if result.returncode == 0:
                    show_step_detail("Stirling PDF updated successfully!")
                    return True
