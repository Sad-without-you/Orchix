...
def _backup_volume_linux(container_name, backup_file):
    ...
    try:
        ...
        for mount in mounts:
            if mount.get('Type') == 'volume' and 'data' in mount.get('Name', ''):
                volume_name = mount.get('Name')
                break
        
        if not volume_name:
            show_error("No data volume found!")
            return False
...
def _create_metadata(container_name, backup_file):
    ...
    create_metadata(container_name, backup_file, 'nextcloud')
