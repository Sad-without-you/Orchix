        ...
        <div style="padding:16px;background:var(--surface2);border-radius:var(--radius-sm);border:1px solid var(--border)">
            <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px">
                ...
                <div style="flex:1">
                    ...
                    <div style="font-size:1.05rem;font-weight:700;color:var(--text)">${updateRes && updateRes.current_version ? 'v' + esc(updateRes.current_version) : 'v1.4'}</div>
                </div>
            </div>
